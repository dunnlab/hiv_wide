...
#SBATCH --array=0-99
#SBATCH -J iqtree
#SBATCH -e /gpfs/data/cbc/aguang/hiv_wide/logs/iqtree-wgs100-%A-%a.err
#SBATCH -o /gpfs/data/cbc/aguang/hiv_wide/logs/iqtree-wgs100-%A-%a.out
...
singularity exec ${SINGULARITY_IMG} iqtree -nt 8 -mem 16G  -s ${ALIGNMENTS}/${fa} -m GTR+F+I+G4 -alrt 1000 -bb 1000 -wbt -wbtl -pre ${WORKDIR}/results/trees/${seed}/${fa}
