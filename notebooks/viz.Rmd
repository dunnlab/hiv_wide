...
names(tp) <- c("90","95","99")
tp$tree <- rownames(tp)
tp <- pivot_longer(tp, cols=c("90","95","99"), names_to="bootstrap", values_to="tp")
...
# 1194 - fn = tn
cluster_compare <- pivot_longer(fp, cols=c("90","95","99"), names_to="bootstrap",values_to="totalclust") %>% left_join(tp) %>%
